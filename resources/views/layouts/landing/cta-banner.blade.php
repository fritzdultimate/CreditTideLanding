<!-- ══ CTA BANNER ══ -->
<section class="px-6 lg:px-12 py-20 bg-bg">
    <div
        class="max-w-4xl mx-auto text-center bg-gradient-to-br from-accent/10 to-accent3/10 border border-accent/20 rounded-3xl px-8 py-16 relative overflow-hidden">
        <div class="absolute -top-20 -right-20 w-64 h-64 rounded-full"
            style="background:radial-gradient(circle,rgba(43,110,255,0.12),transparent 70%)"></div>
        <div
            class="text-xs font-semibold tracking-[1.5px] uppercase text-accent2 flex items-center justify-center gap-2 mb-4">
