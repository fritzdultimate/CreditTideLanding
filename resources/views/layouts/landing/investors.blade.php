            ...
            @foreach($investors as $investor)
                <div
                    ...
                    <div class="text-xl opacity-50 group-hover:opacity-100 transition-opacity flex-shrink-0 w-6 h-6">
                        @if($investor->icon && $investor->icon != 'amazon')
                            <img
