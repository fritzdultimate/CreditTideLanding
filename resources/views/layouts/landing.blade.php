...
<html lang="en" class="scroll-smooth">
    ...
    <body class="font-body bg-bg text-t1">
        ...
        <nav id="main-nav" class="fixed top-0 left-0 right-0 z-40 h-16 bg-[rgba(3,6,15,0.9)] backdrop-blur-xl flex items-center justify-between px-6 lg:px-12" style="box-shadow:0 1px 0 rgba(255,255,255,0.08)">
            <a href="index.html" class="font-display font-extrabold text-lg flex items-center gap-2 text-t1 no-underline">
            ...
            <ul class="hidden lg:flex items-center gap-1 list-none">
                ...
                <div class="dropdown absolute top-full left-0 -mt-px bg-bg2 border border-white/[0.08] rounded-xl p-2 pt-3 min-w-[180px] shadow-2xl z-50">
                    <a href="blog.html" class="block px-4 py-2 text-t2 text-sm rounded-lg hover:bg-white/[0.07] hover:text-t1 transition-colors no-underline">Investment Articles</a>
                    <a href="blog.html" class="block px-4 py-2 text-t2 text-sm rounded-lg hover:bg-white/[0.07] hover:text-t1 transition-colors no-underline">Financial Tips</a>
                    <a href="blog.html" class="block px-4 py-2 text-t2 text-sm rounded-lg hover:bg-white/[0.07] hover:text-t1 transition-colors no-underline">News Insight</a>
                </div>
                </li>
                <li class="has-dropdown relative">
                ...
                <div class="dropdown absolute top-full left-0 -mt-px bg-bg2 border border-white/[0.08] rounded-xl p-2 pt-3 min-w-[180px] shadow-2xl z-50">
                    <a href="payment.html" class="block px-4 py-2 text-t2 text-sm rounded-lg hover:bg-white/[0.07] hover:text-t1 transition-colors no-underline">Payment Policy</a>
        ...
        <div id="mob-menu" class="mob-menu fixed top-16 left-0 right-0 z-30 bg-bg2 overflow-hidden">
            <div class="p-4 flex flex-col gap-1 border-t border-white/[0.06]">
                <a href="company.html"        class="block py-3 px-4 text-t2 rounded-lg hover:bg-white/[0.07] hover:text-t1 transition-colors no-underline">Our Company</a>
                <a href="leadership.html"     class="block py-3 px-4 text-t2 rounded-lg hover:bg-white/[0.07] hover:text-t1 transition-colors no-underline">Our Leadership</a>
                <a href="diversity.html"      class="block py-3 px-4 text-t2 rounded-lg hover:bg-white/[0.07] hover:text-t1 transition-colors no-underline">Diversity &amp; Inclusion</a>
                <a href="responsibility.html" class="block py-3 px-4 text-t2 rounded-lg hover:bg-white/[0.07] hover:text-t1 transition-colors no-underline">Corporate Responsibility</a>
                <a href="plans.html"          class="block py-3 px-4 text-t2 rounded-lg hover:bg-white/[0.07] hover:text-t1 transition-colors no-underline">Investment Plans</a>
                <a href="calculator.html"     class="block py-3 px-4 text-t2 rounded-lg hover:bg-white/[0.07] hover:text-t1 transition-colors no-underline">Profit Calculator</a>
                <a href="blog.html"           class="block py-3 px-4 text-t2 rounded-lg hover:bg-white/[0.07] hover:text-t1 transition-colors no-underline">Blog &amp; Insights</a>
                <a href="payment.html"        class="block py-3 px-4 text-t2 rounded-lg hover:bg-white/[0.07] hover:text-t1 transition-colors no-underline">Payment Policy</a>
                ...
                <a href="plans.html" class="flex-1 py-2.5 bg-accent rounded-lg text-white text-sm font-medium text-center no-underline hover:bg-blue-500 transition-all">Join Us Now</a>
                </div>
            </div>
        </div>
